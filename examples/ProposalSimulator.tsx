...
/**
 * Combined educational simulator for multi-sig proposals.
 * Allows toggling approvals and shows real-time threshold status.
 */
export function ProposalSimulator({ threshold, approvers, className = '' }: ProposalSimulatorProps) {
  ...
  return (
    <div className={`rounded-2xl border border-white/10 p-6 ${className}`}>
      <h3 className="font-semibold mb-4">Proposal Simulator</h3>
